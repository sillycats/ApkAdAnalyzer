...
- **在线广告厂商特征库**：内置网络获取广告厂商广告特征，联网一键同步国内外主流广告厂商（AdMob / Meta / AppLovin / Unity / 穿山甲 / 优量汇 / 百度 / 快手等）的特征，并与内置特征自动合并联合分析，离线自动使用本地缓存
...
| 版本 | 说明 |
|------|------|
| **v1.3** | 新增在线广告厂商特征库：网络同步国内外 19 家主流广告厂商特征并与内置联合分析 |
| **v1.2** | 修复内置默认广告特征配置为空导致"分析不出广告特征"的问题，补齐 1300+ 条内置特征 |
